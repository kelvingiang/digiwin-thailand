...
class Taxonomy_News
{
    ...
    private $prefix_name = 'option_news_category_';
    ...
    public function __construct()
    {
        ...
        add_filter("manage_edit-news_category_columns", array($this, 'category_columns'), 10, 3);
        add_filter("manage_news_category_custom_column", array($this, 'category_columns_manage'), 10, 3);
